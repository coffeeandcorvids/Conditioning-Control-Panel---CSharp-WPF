...
namespace ConditioningControlPanel.Core.Settings
{
    ...
    public class AudioSyncSettings : INotifyPropertyChanged
    {
        ...
        /// </summary>
        [JsonPropertyName("manual_latency_offset_ms")]
        ...
        /// </summary>
        [JsonPropertyName("chunk_duration_seconds")]
        ...
        /// </summary>
        [JsonPropertyName("min_buffer_ahead_seconds")]
        ...
        /// </summary>
        [JsonPropertyName("live_intensity")]
